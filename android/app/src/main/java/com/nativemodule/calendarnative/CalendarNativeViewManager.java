package com.nativemodule.calendarnative;
...
public class CalendarNativeViewManager extends SimpleViewManager<MaterialCalendarView> {

    public static final String REACT_COMPONENT = "CalendarNativeAndroid";
    ...
    @Override
    protected MaterialCalendarView createViewInstance(@NonNull ThemedReactContext reactContext) {
    ...
    public void setDay(MaterialCalendarView view, int day){
        ...
        Log.d("DAY-DATE", day + " - " + dateRepresentation);
    ...
    public void setMonth(MaterialCalendarView view, int month){
        ...
        Log.d("MONTH-DATE", month + " - " + dateRepresentation);
        view.setSelectedDate(dateRepresentation);
    }
